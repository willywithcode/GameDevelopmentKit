namespace GameFoundation.Scripts.Patterns.MVP
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        private void ApplySafeArea(Rect r)
        {
            ...
            //Debug.LogFormat("New safe area applied to {0}: x={1}, y={2}, w={3}, h={4} on full extents w={5}, h={6}", name, r.x, r.y, r.width, r.height, UnityEngine.Screen.width, UnityEngine.Screen.height);
        }
    }
}